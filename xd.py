...
while intentos > 0:
    input_numero_celular = input("Ingrese su número de celular: ")
    input_clave = input("Ingrese su clave de 4 dígitos: ")

    if input_numero_celular == numero_celular and input_clave == clave:
